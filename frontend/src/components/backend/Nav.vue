        ...
        <div
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
                ...
                <li class="relative">
                    ...
                    <!-- binding class เข้าไป ถ้า showNotificationMenu มีค่าเป็น true ก็จะ เพิ่ม class block เข้าไปแต่ถ้าเป็น false ก็จะลบค่า block ไป-->
                ...
                <button
                    ...
                    <!-- binding class เข้าไป ถ้า showProfileMenu มีค่าเป็น true ก็จะ เพิ่ม class block เข้าไปแต่ถ้าเป็น false ก็จะลบค่า block ไป-->
...
export default {
    ...
    methods: {
        ...
        onClickShowNotification(){
            this.showNotificationMenu = !this.showNotificationMenu //สลับค่า toggle ไปมาทำให้สามารถเปิดปิดเมนูได้
