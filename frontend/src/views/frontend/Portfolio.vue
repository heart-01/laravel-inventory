            ...
            <div class="flex flex-wrap items-center mb-4">
                <div class="w-full p-4 lg:w-3/12 sm:w-6/12">
                    <a href="#" class="block text-left hover:opacity-75"> 
                        <images src="@/assets/images/images-work-1.jpg" class="object-cover w-full h-64"/> 
                ...
                <div class="w-full p-4 lg:w-3/12 sm:w-6/12">
                    <a href="#" class="block text-left hover:opacity-75"> 
                        <images src="@/assets/images/images-work-2.jpg" class="object-cover w-full h-64"/> 
                        <div class="flex items-center justify-between px-4 py-3 bg-indigo-100">
                ...
                <div class="w-full p-4 lg:w-3/12 sm:w-6/12">
                    <a href="#" class="block text-left hover:opacity-75"> 
                        <images src="@/assets/images/images-work-3.jpg" class="object-cover w-full h-64"/> 
                        <div class="flex items-center justify-between px-4 py-3 bg-indigo-100">
                ...
                <div class="w-full p-4 lg:w-3/12 sm:w-6/12">
                    <a href="#" class="block text-left hover:opacity-75"> 
                        <images src="@/assets/images/images-work-4.jpg" class="object-cover w-full h-64"/> 
                        <div class="flex items-center justify-between px-4 py-3 bg-indigo-100">
